...
DataPipeObj_TypeDef Sensor_log_DataPipe = {.enable = true};
DataPipeObj_TypeDef Sensor_smp_DataPipe = {.enable = true};
DataPipeObj_TypeDef Sensor_hub_DataPipe = {.enable = true};
